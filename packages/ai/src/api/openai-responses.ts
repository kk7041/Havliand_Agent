...
// OpenAI Responses rejects max_output_tokens below 16: https://github.com/kk7041/havliand_agent/issues/6265
 ...
 * Defaults to "short" and uses HAVLIAND_AGENT_CACHE_RETENTION for backward compatibility.
 */
function resolveCacheRetention(cacheRetention?: CacheRetention, env?: ProviderEnv): CacheRetention {
	if (cacheRetention) {
		return cacheRetention;
	}
	if (getProviderEnvValue("HAVLIAND_AGENT_CACHE_RETENTION", env) === "long") {
		return "long";
	}
	return "short";
}
