/**
 * Temporary compatibility entrypoint preserving the old global havliand_agent-ai API
 ...
 *
 * Existing apps switch imports from "@havliand_agent/ai" to
 * "@havliand_agent/ai/compat" unchanged; new code uses `createModels()`
...
export * from "./api/havliand_agent-messages.lazy.ts";
...
import { havliand_agentMessagesApi } from "./api/havliand_agent-messages.lazy.ts";
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@havliand_agent/ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@havliand_agent/ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@havliand_agent/ai/providers/all" or `Models.getProviders()`. */
...
const BUILTIN_APIS: [Api, ProviderStreams][] = [
	...
	["havliand_agent-messages", havliand_agentMessagesApi()],
];
