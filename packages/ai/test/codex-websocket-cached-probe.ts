 ...
 *
 * Runs a simple tool loop directly against the havliand_agent-ai provider source so it does not
...
function parseArgs(argv: string[]): Args {
	...
	let sessionId = `havliand_agent-ai-codex-ws-cached-probe-${Date.now()}`;
