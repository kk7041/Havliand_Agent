...
import { Editor, type EditorTheme, Key, matchesKey, Text, visibleWidth, wrapTextWithAnsi } from "@havliand_agent/tui";
...
export default function questionnaire(havliand_agent: ExtensionAPI) {
