 ...
 * (logo + keybinding hints) with a custom component showing the havliand_agent mascot.
 */

import type { ExtensionAPI, Theme } from "@havliand_agent/coding-agent";
import { VERSION } from "@havliand_agent/coding-agent";

// --- PI MASCOT ---
// Based on pi_mascot.ts - the havliand_agent agent character
...
export default function (havliand_agent: ExtensionAPI) {
	...
	havliand_agent.registerCommand("builtin-header", {
