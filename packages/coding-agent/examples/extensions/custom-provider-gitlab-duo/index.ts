 ...
 * Delegates to havliand_agent-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   havliand_agent -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (havliand_agent: ExtensionAPI) {
	havliand_agent.registerProvider("gitlab-duo", {
