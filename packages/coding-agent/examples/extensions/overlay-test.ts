 ...
 *
 * Usage: havliand_agent --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@havliand_agent/tui";

export default function (havliand_agent: ExtensionAPI) {
	havliand_agent.registerCommand("overlay-test", {
