...
Play DOOM as an overlay in havliand_agent. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
havliand_agent --extension ./examples/extensions/doom-overlay
```
...
- [havliand_agent-doom](https://github.com/kk7041/havliand_agent) for the original havliand_agent integration
