#!/usr/bin/env bash
# Build DOOM for HavliandAgent Doom using doomgeneric and Emscripten
...
echo "=== HavliandAgent Doom Build Script ==="
...
cp "$DOOM_DIR/doomgeneric_havliand_agent.c" "$DOOM_DIR/doomgeneric/doomgeneric/"
