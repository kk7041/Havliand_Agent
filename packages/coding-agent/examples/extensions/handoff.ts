...
import { complete, type Message } from "@havliand_agent/ai/compat";
import type { ExtensionAPI, SessionEntry } from "@havliand_agent/coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@havliand_agent/coding-agent";
