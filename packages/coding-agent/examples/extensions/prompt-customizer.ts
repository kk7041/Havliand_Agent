...
import type { BuildSystemPromptOptions, ExtensionAPI } from "@havliand_agent/coding-agent";
...
export default function promptCustomizer(havliand_agent: ExtensionAPI) {
