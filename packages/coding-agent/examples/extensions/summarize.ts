import { complete, getModel } from "@havliand_agent/ai/compat";
import type { ExtensionAPI, ExtensionCommandContext } from "@havliand_agent/coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@havliand_agent/coding-agent";
import { Container, Markdown, matchesKey, Text } from "@havliand_agent/tui";
...
export default function (havliand_agent: ExtensionAPI) {
	havliand_agent.registerCommand("summarize", {
