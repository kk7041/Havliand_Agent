 ...
 * - Routing tool calls to remote systems (e.g., havliand_agent-ssh-remote)
...
import type { TextContent } from "@havliand_agent/ai";
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@havliand_agent/coding-agent";
...
export default function (havliand_agent: ExtensionAPI) {
	...
	havliand_agent.registerCommand("read-log", {
