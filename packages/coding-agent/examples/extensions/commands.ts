 ...
 * Commands Extension
 *
 * Demonstrates the havliand_agent.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@havliand_agent/coding-agent";

export default function commandsExtension(havliand_agent: ExtensionAPI) {
	havliand_agent.registerCommand("commands", {
