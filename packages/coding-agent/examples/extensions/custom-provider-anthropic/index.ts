 ...
 *   havliand_agent -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... havliand_agent -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (havliand_agent: ExtensionAPI) {
	havliand_agent.registerProvider("custom-anthropic", {
