...
import { createAgentSession, DefaultResourceLoader, getAgentDir, SessionManager } from "@havliand_agent/coding-agent";
...
export default function (havliand_agent: ExtensionAPI) {
	havliand_agent.on("agent_start", async () => {
	...
	havliand_agent.on("agent_end", async (event) => {
	...
	// Register a command
	havliand_agent.registerCommand("mycommand", {
