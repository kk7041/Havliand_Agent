...
// Regression for https://github.com/kk7041/havliand_agent/issues/5080
//
...
function createSessionManager(options: { sessionFile?: string } = {}): SessionManager {
	return {
		...
		getSessionDir: () => "/tmp/havliand_agent-sessions",
		usesDefaultSessionDir: () => true,
	} as unknown as SessionManager;
}

function createTempFile(): string {
	const dir = mkdtempSync(join(tmpdir(), "havliand_agent-shutdown-resume-hint-"));
	tempDirs.push(dir);
