...
/**
 * Regression test for https://github.com/kk7041/havliand_agent/issues/2791
 *
...
process.env.HAVLIAND_AGENT_CODING_AGENT_DIR = "${agentDir}";
...
`,
		...
		try {
			_stdout = execFileSync(process.execPath, [scriptPath], {
				timeout: 10000,
				encoding: "utf-8",
				env: { ...process.env, HAVLIAND_AGENT_CODING_AGENT_DIR: agentDir },
