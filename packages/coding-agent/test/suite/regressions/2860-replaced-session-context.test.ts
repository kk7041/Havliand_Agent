...
import { fauxAssistantMessage, registerFauxProvider } from "@havliand_agent/ai/compat";
...
describe("regression #2860: replaced session callbacks", () => {
	...
	it("rebinds before withSession, targets the replacement session, and invalidates stale havliand_agent/ctx", async () => {
		const events: string[] = [];
