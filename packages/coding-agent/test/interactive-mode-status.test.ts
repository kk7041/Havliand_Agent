...
import { type AutocompleteProvider, CombinedAutocompleteProvider } from "@havliand_agent/tui";
...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			{
				path: "/tmp/project/.havliand_agent/extensions/answer.ts",
				sourceInfo: createSourceInfo("/tmp/project/.havliand_agent/extensions/answer.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.havliand_agent/extensions",
				}),
			},
			{
				path: "/tmp/project/.havliand_agent/extensions/local-index/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.havliand_agent/extensions/local-index/index.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.havliand_agent/extensions",
			...
			{
				path: "/tmp/project/.havliand_agent/npm/node_modules/havliand_agent-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.havliand_agent/npm/node_modules/havliand_agent-markdown-preview/extensions/index.ts",
					{
						source: "npm:havliand_agent-markdown-preview",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.havliand_agent/npm/node_modules/havliand_agent-markdown-preview",
					},
				),
			},
			{
				path: "/tmp/project/.havliand_agent/npm/node_modules/@scope/havliand_agent-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.havliand_agent/npm/node_modules/@scope/havliand_agent-scoped/extensions/index.ts",
					{
						source: "npm:@scope/havliand_agent-scoped",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.havliand_agent/npm/node_modules/@scope/havliand_agent-scoped",
					},
				),
			},
			{
				path: "/tmp/project/.havliand_agent/git/github.com/HavliandAgent/interactive-subagents/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.havliand_agent/git/github.com/HavliandAgent/interactive-subagents/extensions/index.ts",
					{
						source: "git:github.com/HavliandAgent/interactive-subagents",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.havliand_agent/git/github.com/HavliandAgent/interactive-subagents",
					},
				),
			},
			{
				path: "/tmp/project/.havliand_agent/git/github.com/HavliandAgent/interactive-subagents/extensions/subagents/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.havliand_agent/git/github.com/HavliandAgent/interactive-subagents/extensions/subagents/index.ts",
					{
						source: "git:github.com/HavliandAgent/interactive-subagents",
						scope: "project",
						origin: "package",
...
"[Extensions]
  @scope/havliand_agent-scoped, answer.ts, cli-extension.ts, HavliandAgent/interactive-subagents, HavliandAgent/interactive-subagents:subagents, local-index, havliand_agent-markdown-preview, user-index"`);
	});
...
"[Extensions]
  main.ts"`);
	...
	test("package extensions still strip index.ts correctly (regression guard)", () => {
		...
		expect(normalizeRenderedOutput(fakeThis.loadedResourcesContainer)).toMatchInlineSnapshot(`
"[Extensions]
  havliand_agent-markdown-preview"`);
	});
...
"[Extensions]
  project
    /tmp/project/.havliand_agent/extensions/answer.ts
    /tmp/project/.havliand_agent/extensions/local-index
    git:github.com/HavliandAgent/interactive-subagents
      extensions
      extensions/subagents
    npm:@scope/havliand_agent-scoped
      extensions
    npm:havliand_agent-markdown-preview
      extensions
  user
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		const home = homedir();
		const cwd = path.join(home, "Development", "havliand_agent");
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			contextFiles: [
				{ path: path.join(home, ".havliand_agent", "agent", "AGENTS.md") },
		...
		expect(output).toContain("~/.havliand_agent/agent/AGENTS.md, AGENTS.md");
	...
	test("shows full context paths when expanded", () => {
		...
		const output = renderAll(fakeThis.loadedResourcesContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain("~/.havliand_agent/agent/AGENTS.md");
		expect(output).toContain("~/Development/havliand_agent/AGENTS.md");
		expect(output).not.toContain("~/.havliand_agent/agent/AGENTS.md, AGENTS.md");
	});
