...
import { Agent, type AgentEvent, type AgentTool } from "@havliand_agent/agent-core";
import { type AssistantMessage, type AssistantMessageEvent, EventStream, getModel } from "@havliand_agent/ai/compat";
