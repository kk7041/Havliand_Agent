...
import type { AssistantMessage, Model } from "@havliand_agent/ai";
...
vi.mock("@havliand_agent/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@havliand_agent/ai/compat")>();
	return {
		...actual,
