...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@havliand_agent/agent-core";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@havliand_agent/ai/compat";
import { completeSimple } from "@havliand_agent/ai/compat";
...
function extractFileOperations(
	...
	// Collect from previous compaction's details (if HavliandAgent-generated)
