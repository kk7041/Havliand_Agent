    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="havliand_agent-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="havliand_agent-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'havliand_agent-share:v1:sidebar-width';
