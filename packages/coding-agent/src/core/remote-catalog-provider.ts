import type { Api, Model, Provider } from "@havliand_agent/ai";
import { VERSION } from "../config.ts";
import { getHavliandAgentUserAgent } from "../utils/havliand_agent-user-agent.ts";

const DEFAULT_CATALOG_BASE_URL = "https://havliand_agent.dev";
...
/** Add a persisted HavliandAgent catalog overlay to a static built-in provider. */
