...
export class AgentSession {
	 ...
	 * - Handles extension commands (registered via HavliandAgent API registerCommand) immediately, even during streaming
	...
	async prompt(text: string, options?: PromptOptions): Promise<void> {
		...
		try {
			...
			// Extension commands manage their own LLM interaction via HavliandAgent API sendMessage()
