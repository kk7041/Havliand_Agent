...
import type { Transport } from "@havliand_agent/ai";
...
export interface Settings {
	...
	enableInstallTelemetry?: boolean; // default: true - anonymous version/update havliand_agentng after changelog-detected updates
	...
	httpProxy?: string; // Proxy URL applied as HTTP_PROXY and HTTPS_PROXY for HavliandAgent-managed HTTP clients
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.HAVLIAND_AGENT_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.HAVLIAND_AGENT_HARDWARE_CURSOR === "1";
	}
