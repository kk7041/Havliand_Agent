import { ProcessTerminal, setKeybindings, TUI } from "@havliand_agent/tui";
...
const OFFICIAL_PACKAGE_NAME = "@havliand_agent/coding-agent";
const OFFICIAL_APP_NAME = "havliand_agent";
const OFFICIAL_CONFIG_DIR_NAME = ".havliand_agent";
 ...
 * - this is the official havliand_agent distribution (not a fork/rebrand)
 * - experimental features are enabled (HAVLIAND_AGENT_EXPERIMENTAL=1)
