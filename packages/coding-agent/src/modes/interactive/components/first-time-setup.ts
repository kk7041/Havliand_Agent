import { Container, getKeybindings, Spacer, Text } from "@havliand_agent/tui";
		...
		if (this.step === "theme") {
			...
			this.addChild(
				new Text(
					theme.fg(
						"muted",
						"Opting in stores a tracking identifier in settings.json and enables anonymous\nusage analytics. This helps us to better debug, reproduce, and resolve issues\nand bugs within havliand_agent. You can observe what is shared using /privacy and make\nchanges anytime in settings.json.",
					),
					1,
					0,
				),
