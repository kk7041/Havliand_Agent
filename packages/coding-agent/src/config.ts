...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download the latest havliand_agent binary from the release channel that provided this installation.`;
	}
...
export function getPackageDir(): string {
	...
	const envDir = process.env.HAVLIAND_AGENT_PACKAGE_DIR;
	if (envDir) {
...
export function getBuiltinSkillsDir(): string {
	...
	const packageDir = getPackageDir();
	const srcOrDist = existsSync(join(packageDir, "src")) ? "src" : "dist";
	return join(packageDir, srcOrDist, "core", "builtin-skills");
}
...
// =============================================================================
// App Config (from package.json havliand_agentConfig)
// =============================================================================

interface PackageJson {
	name?: string;
	version?: string;
	havliand_agentConfig?: {
		name?: string;
		configDir?: string;
	};
}
...
const havliand_agentConfigName: string | undefined = pkg.havliand_agentConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "@havliand_agent/coding-agent";
export const APP_NAME: string = havliand_agentConfigName || "havliand_agent";
export const APP_TITLE: string = havliand_agentConfigName ? APP_NAME : "havliand_agent";
export const CONFIG_DIR_NAME: string = pkg.havliand_agentConfig?.configDir || ".havliand_agent";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., HAVLIAND_AGENT_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
const DEFAULT_SHARE_VIEWER_URL = "https://havliand_agent.dev/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.HAVLIAND_AGENT_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.havliand_agent/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.havliand_agent/agent/) */
