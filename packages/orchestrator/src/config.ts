...
const CONFIG_DIR_NAME = ".havliand_agent";
const ENV_ORCHESTRATOR_DIR = "HAVLIAND_AGENT_ORCHESTRATOR_DIR";
...
export function getOrchestratorDir(): string {
	...
	const configDir = process.env.HAVLIAND_AGENT_CONFIG_DIR || join(homedir(), CONFIG_DIR_NAME);
