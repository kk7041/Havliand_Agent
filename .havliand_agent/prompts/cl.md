...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/kk7041/havliand_agent/issues/123))`
- External: `Added bar ([#456](https://github.com/kk7041/havliand_agent/pull/456) by [@user](https://github.com/user))`
