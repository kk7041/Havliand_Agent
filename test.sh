...
AUTH_FILE="$HOME/.havliand_agent/agent/auth.json"
AUTH_BACKUP="$HOME/.havliand_agent/agent/auth.json.bak"
...
export HAVLIAND_AGENT_NO_LOCAL_LLM=1
...
unset HAVLIAND_AGENT_GATEWAY
unset HAVLIAND_AGENT_EXPERIMENTAL
