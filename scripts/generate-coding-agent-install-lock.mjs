...
const internalPackagePrefix = "@havliand_agent/";
const installPackageName = "@havliand_agent/coding-agent-install";
...
function createInstallerPackageJson(codingAgentPackage) {
	const packageJson = {
		...
		private: true,
		description: "Lockfile root used by the HavliandAgent installer and updater.",
		dependencies: {
